        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div>
            <h3 className="text-xl md:text-2xl font-bold text-white mb-4 md:mb-6">
              K B FINANCIAL <span className="text-[#D4AF37]">SERVICES</span>
            </h3>
            <p className="text-xs md:text-sm leading-relaxed mb-4 md:mb-6 text-gray-400">
              Your trusted partner for practical financial solutions. We provide transparent guidance and customer-focused service to help individuals and businesses secure their tomorrow.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3 text-xs md:text-sm">
              <li>
                <Link href="/services#personal" className="hover:text-[#D4AF37] transition-colors">Personal Loans</Link>
              </li>
              <li>
                <Link href="/services#business" className="hover:text-[#D4AF37] transition-colors">Business Loans</Link>
              </li>
              <li>
                <Link href="/services#home" className="hover:text-[#D4AF37] transition-colors">Home Loans</Link>
              </li>
              <li>
                <Link href="/services#vehicle" className="hover:text-[#D4AF37] transition-colors">Vehicle Loans</Link>
              </li>
              <li>
                <Link href="/services#planning" className="hover:text-[#D4AF37] transition-colors">Financial Planning</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4 text-xs md:text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>1st Floor, National Market, Andhrapool, Varanasi, U.P. – 221002</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 md:w-5 md:h-5 text-[#D4AF37] shrink-0" />
                <span>7081000063</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-4 h-4 md:w-5 md:h-5 text-[#D4AF37] shrink-0" />
                <a href="mailto:FINANCESERVICESKB@GMAIL.COM" className="hover:text-[#D4AF37] transition-colors">
                  FINANCESERVICESKB@GMAIL.COM
                </a>
              </li>
            </ul>
          </div>
